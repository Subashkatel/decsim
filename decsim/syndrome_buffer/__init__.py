...
reads from the room side (decsim/build/stores.py), and strong_round_receiver.py
is that store's priced crossing. round_output.py is a store's face on the data
