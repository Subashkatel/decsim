...
arguments, which is why `docs/explanation/time.md` exists and why the
...
between two pieces of work. `docs/explanation/decisions.md` is where
...
- `docs/explanation/decisions.md`: the ten modelling decisions made
  under them.
- `docs/explanation/architecture.md`: the shape they produced.
