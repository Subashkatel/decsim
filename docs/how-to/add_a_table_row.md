...
`docs/reference/tables.md`. This is the recipe for adding a row to any
of them.
...
`docs/reference/ports.md` is the same file as a page, with every method
...
`docs/reference/tables.md` says which file each table is in and which
yaml key names it.
...
- `docs/how-to/plug_in_without_a_table_row.md`: skip step 2 while the
  class is still changing.
- `docs/how-to/add_a_decoder_backend.md`: the decoder case in full.
- `docs/reference/tables.md`: all seventeen tables and their rows.
