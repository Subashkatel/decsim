...
because the mode picks the wire: weak_baseline moves windows on cwd and
...
POINTS = (
    ...
    "input_link_per_window",   # unit assigned -> input in its decoder memory (cwd weak, csd strong)
...
INPUT_LINK = {"weak_baseline": "cwd", "strong_only": "csd"}
