...
|---|---|---|---|---|---|
| 5 | 0.388 | 0.334 | 0.86 | 36.2 | 108.5 |
| 7 | 1.055 | 1.089 | 1.03 | 45.4 | 41.7 |
| 9 | 2.315 | 2.455 | 1.06 | 70.2 | 28.6 |
| 13 | 6.966 | 7.928 | 1.14 | 159.8 | 20.2 |
| 17 | 16.006 | 17.964 | 1.12 | 289.3 | 16.1 |
...
The pipeline decodes sliding windows (commit d, buffer d) serially with real boundary handoff, so its rate may sit slightly above the whole-circuit reference; a rate significantly below it, or outside the binomial interval of the pipeline shot count, would indicate a data-path defect.
