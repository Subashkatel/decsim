...
from decsim.pauli_frame import PauliFrame as RuntimePauliFrame
...
def test_short_provenance_header_round_trips_from_source_and_wheel(tmp_path):
    ...
    module_bytes = (project_root / "decsim" / "pauli_frame.py").read_bytes()
    ...
    with zipfile.ZipFile(wheel_paths[0]) as wheel:
        shipped_module = wheel.read("decsim/pauli_frame.py")
