...
SEED = 0
# the log hash of the point, moved by Buffer 0 taking its slot at the
# landing of controller_to_weak_buffer, which moves its intake line by
# the crossing (the results the gate hashes are unchanged; the frozen
# golden's own log hash is regenerated by the coordinator)
POINT_LOG_SHA256 = "5a0656025eb0"
